...
class TestCalculateHistogramLevels:
    ...
    def test_linear_method(self, sample_normal_data):
        ...
        levels = calculate_histogram_levels(sample_normal_data, n_levels=10, method='linear')
    ...
    def test_percentile_method(self, sample_skewed_data):
        ...
        levels = calculate_histogram_levels(sample_skewed_data, n_levels=20, method='percentile')
    ...
    def test_histogram_method(self, sample_normal_data):
        ...
        levels = calculate_histogram_levels(sample_normal_data, n_levels=15, method='histogram')
    ...
    def test_compressed_percentile_method(self, sample_skewed_data):
        ...
        central_levels = levels[(levels >= central_range[0]) & (levels <= central_range[1])]
    ...
    def test_symmetric_zero_method(self):
        ...
        velocity_data = np.concatenate([velocity_data, [2.5, -2.3]])  # Add some extremes
        
        # Test with even number of levels
        levels_even = calculate_histogram_levels(velocity_data, n_levels=10, method='symmetric_zero')
        ...
        levels_odd = calculate_histogram_levels(velocity_data, n_levels=9, method='symmetric_zero')
...
class TestInteractiveColormapWidget:
    ...
    def test_widget_controls_creation(self, sample_normal_data):
        ...
        assert widget.n_levels_slider.max == 50
...
class TestColormapIntegration:
    ...
    def test_boundary_norm_with_calculated_levels(self, sample_normal_data):
        """Test BoundaryNorm with calculated levels."""
        levels = calculate_histogram_levels(sample_normal_data, 10, 'percentile')
        norm = BoundaryNorm(levels, 10, extend='both')
