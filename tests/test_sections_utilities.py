...
class TestSectionUtilityFunctions:
    ...
    def test_get_long_name_fallback_to_variable_name(self):
        ...
        data = xr.Dataset({"mystery_var": (["x"], [1, 2, 3])}, coords={"x": [1, 2, 3]})
...
class TestDataValidation:
    ...
    def test_dataset_variable_checking(self):
        ...
        data = xr.Dataset(
            ...
            coords={"x": np.linspace(0, 100, 10), "y": np.linspace(0, 1000, 5)},
        )
    ...
    def test_coordinate_dimension_validation(self):
        ...
        data = xr.Dataset(
            ...
            coords={"distance": x_coords, "pressure": y_coords},
        )
...
class TestCoordinateHandling:
    ...
    def test_alternative_coordinate_names(self):
        ...
        data = xr.Dataset(
            ...
            coords={"profile": np.arange(8), "depth": np.linspace(0, 500, 12)},
        )
...
class TestErrorHandling:
    ...
    def test_single_point_dataset(self):
        ...
        single_point = xr.Dataset({"temp": (["x"], [25.0])}, coords={"x": [0]})
